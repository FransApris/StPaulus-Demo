    ...
    <div class="w-64 bg-white shadow-lg">
      <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
          ...
          <NuxtLink
            to="/admin/liturgy-schedules"
            class="flex items-center px-4 py-2 text-sm font-medium rounded-md transition-colors duration-200"
            :class="$route.path === '/admin/liturgy-schedules' ? 'bg-[#882f1d] text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'"
          >
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
            </svg>
            Kelola Jadwal Liturgi
          </NuxtLink>
...
const pageTitle = computed(() => {
  ...
  if (route.path === '/admin/liturgy-schedules') return 'Kelola Jadwal Liturgi'
